...
- Cart & checkout: Add/remove/update items; order placement with address/payment status.
- Admin dashboard: Create/edit/delete products, view orders, manage inventory.
- Reviews & ratings: Users can review purchased headphones (optional).
...
- Auth: JWT, bcrypt
- Frontend (optional): React + Vite/CRA or server-side rendered EJS
